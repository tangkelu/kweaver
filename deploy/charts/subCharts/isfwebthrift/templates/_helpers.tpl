...
Common labels
*/}}
{{- define "isfweb.labels" -}}
app.kubernetes.io/name: {{ include "isfweb.name" . }}
helm.sh/chart: {{ include "isfweb.chart" . }}
...
*/}}
{{- define "isfweb.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "isfweb.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
